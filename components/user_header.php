...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="home.php" class="logo">Onleym</span></a>
      ...
      <div class="profile">
         ...
         <a href="update_user.php" class="btn">Редактировать</a>
         <div class="flex-btn">
            <a href="user_register.php" class="option-btn">Регистрация</a>
            <a href="user_login.php" class="option-btn">Вход</a>
         </div>
         <a href="components/user_logout.php" class="delete-btn" onclick="return confirm('Выйти из аккаунта?');">Выход</a> 
         <?php
            }else{
         ?>
