...
if(isset($_POST['update'])){
   ...
   if(!empty($image_01)){
      if($image_size_01 > 2000000){
         ...
         $message[] = 'изображение 1 обновлено!';
      }
   }
   ...
   if(!empty($image_02)){
      if($image_size_02 > 2000000){
         ...
         $message[] = 'изображение 2 обновлено!';
      }
   }
   ...
   if(!empty($image_03)){
      if($image_size_03 > 2000000){
         ...
         $message[] = 'изображени 3 обновлено!';
      }
   }
...
<section class="update-product">
   ...
   <h1 class="heading">Обновление информации о товаре</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <textarea name="details" class="box" required cols="30" rows="20"><?= $fetch_products['details']; ?></textarea>
      ...
      <div class="flex-btn">
         <input type="submit" name="update" class="btn" value="Сохранить">
   ...
   <?php
         ...
         echo '<p class="empty">Нет товаров!</p>';
      }
   ?>
